...
labels: [openwrt, posix, shell, guidelines]
danger_level: medium
danger_details: Modifying OpenWrt core services or system shell scripts can cause network configuration errors or device bricking. Proceed with caution.
---
