...
labels: ["testing"]
danger_level: "low"
danger_details: "Does not modify external state; runs in isolated mock scopes."
---
# Domain: Agentic Testing

This domain governs the rules and constraints for autonomous testing of AI agents, MCP tools, and JIT rule configurations.
