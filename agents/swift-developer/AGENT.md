...
5. **Cryptography**: ALWAYS use CryptoKit. Avoid CommonCrypto. Never hardcode keys.
6. **Storage**: Store high-security keys in Secure Enclave and general keys in macOS Keychain.
7. **Authenticated Encryption**: Use AES-GCM or ChaChaPoly with strictly unique nonces. Do not log keys or decrypted data.
