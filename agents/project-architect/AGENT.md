...
4. **Define Stack & Generate JIT Rules (CRITICAL):** Once the concept is solid, define the technical stack (e.g., React, Python, Go) and necessary tools. 
   ...
   - If they are missing, invoke the `antiengine-builder` subagent to generate them. 
...
6. **Delegate Research:** If you need to research an unknown framework or domain, delegate the web research immediately. Always rely strictly on verified facts.
</instructions>
